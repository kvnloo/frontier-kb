...
Hermes has execution primitives (Kanban, runs, leases, review, goal/judge) but no machine-readable topology vocabulary. HOTL 0.1/0.2 is the proposed IR; **not merged**, no second scheduler.
